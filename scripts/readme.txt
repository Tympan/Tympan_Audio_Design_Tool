...
The purpose of the index.html is to have GUI tool that generates example Arduino code.  Not all of the pieces of the auto-generated Arduino code are generated by the index.html.  Some is generated in javascript files.  For example, see ..\red\main.js.  Search for the function "save" and you'll see it:

* Adds the #include statements
* Inserts the audio processing nodes
* Inserts the code for the audio connections
* Generates code for the control nodes
* Adds the Arduino setup() function
* Adds the Arduino loop() function
* Creates the dialog box from where the user can copy-paste the auto-generated Arduino code

So, if you want to change the auto-generated Arduino code, you probably will have to change main.js.
